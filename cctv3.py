                    ...
                    for i in cars:
                        if abs(cx-i.getX()) <= w and abs(cy-i.getY()) <= h:
                            ...
                            if i.going_DOWN(line_down,210,line_up,210) == True:
                                ...
                                cv2.imwrite("pelanggaran/melawanarus - " + str(cnt_down) + "-" + str(curr_datetime) +".png", persona)
                                gambar = "pelanggaran/melawanarus - " + str(cnt_down) + "-" + str(curr_datetime) +".png"
                                with open("melawanarus - " + str(cnt_down) + "-" + str(curr_datetime) +".png",'rb') as f:
                                    image_data = f.read()
                                ...
                                sql = "INSERT INTO data_pelanggaran( JENIS_PELANGGARAN, WAKTU, GAMBAR, LOKASI) VALUES ( 'Melawan Arus', now(),'"+gambar+"','Off Ramp Rappokalling')";
