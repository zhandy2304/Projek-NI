...
t2= int(datetime.now().second) + 10
t1 = int(datetime.now().second)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', type=str, default='rtsp://admin:admin123@192.168.1.127:554/live.sdp', help='source') 
    ...
    parser.add_argument('--source2', type=str, default='rtsp://admin:admin123@192.168.22.8:554/live1s3.sdp', help='source') 
    parser.add_argument('--output', type=str, default='inference/output', help='output folder')  # output folder
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[360], help='inference size h,w')
    parser.add_argument('--conf-thres', type=float, default=0.47, help='object confidence threshold')
