...
def count_obj(box, w, h, id):
    ...
    if int(box[1]+(box[3]-box[1])/2) > (250) and int(box[1]+(box[3]-box[1])/2) < (315):
        if id not in data:
            count = truck + car
            data.append(id)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--source', type=str, default='rtsp://admin:admin123@192.168.1.127:554/live3.sdp', help='source')
