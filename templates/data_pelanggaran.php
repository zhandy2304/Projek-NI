                    ...
                    <div class="col-lg-6">
                        <ul class="nav nav-footer justify-content-center justify-content-lg-start">
                            ...
                            <li class="nav-item" style="margin-left:15px">
                                <a href="data_traffic.php" style="color:black; text-decoration: none;"><h7>Data Traffic Lalu Lintas</h6></a>
                            </li>
                        </ul>
                    </div><br>
          ...
          <!-- <div class="main-content" id="panel">
            ...
            <div class="row removable">
                <div class="col-lg-6">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Data Pelanggaran Hari Ini</h6>
                            <!-- <p class="text-sm">
                                <i class="fa fa-arrow-up text-success" aria-hidden="true"></i>
                                <span class="font-weight-bold">4% more</span> in 2021
                            </p> -->
                ...
                <div class="col-lg-6">
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            <h6>Data Pelanggaran Kemarin</h6>
                            <!-- <p class="text-sm">
                                <i class="fa fa-arrow-up text-success" aria-hidden="true"></i>
                                <span class="font-weight-bold">4% more</span> in 2021
                            </p> -->
