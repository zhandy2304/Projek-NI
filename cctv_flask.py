    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if show_vid:
                ...
                color=(0,255,0)
                start_point = (1250, h-1100)
                end_point = (1650, h-1050)
                start_point1 = (700, h-850)
                end_point1 = (1600, h-750)
...
def count_obj(box,w,h,id):
    ...
    if int(box[1]+(box[3]-box[1])/2) > (h-1100) and int(box[1]+(box[3]-box[1])/2) < (h-750) and int(box[0]+(box[2]-box[0])/2)<(1600) and int(box[0]+(box[2]-box[0])/2)>(1000):
        if  id not in data:
            count = truck + car
            data.append(id)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='rtsp://admin:admin123@192.168.3.15:554/live1s3.sdp', help='source')  # file/folder, 0 for webcam
